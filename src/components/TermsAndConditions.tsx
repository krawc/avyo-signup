...
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to The Courage House Non-profit , Elk Grove .
...
Website refers to Avyo In-gathering web-app , accessible from www.thecouragehouse.org
...
By email: manager at thecouragehouse dot org
        `
      };
    } else {
      return {
